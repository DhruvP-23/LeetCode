...
// So the total probability of A becoming empty first plus half the probability that A 
// and B become empty at the same time, is 0.25 * (1 + 1 + 0.5 + 0) = 0.625.
// Example 2:
